...
if ($EnableVerboseLogging) { Write-Verbose 'Verbose logging enabled.' }
...
# Verify required helper functions using the cached lists instead of repeated Get-Command call
