...
$OSDCloudBTN.Add_Click({
    start-process powershell -argumentlist "$PSScriptRoot\iTechDcOSDCloudGUI.ps1"
...
#OSD Cloud
#start-process powershell -argumentlist "-NoL -W Mi -C Start-OSDCloudGUI -Brand 'iTechDc OSD powered by OSDCloud'"
// iTechDc OSD Cloud
start-process powershell -argumentlist "$PSScriptRoot\iTechDcOSDCloudGUI.ps1"
})
